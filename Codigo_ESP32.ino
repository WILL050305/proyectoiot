/*
 * Sistema de Riego Inteligente Optimizado con ESP32 y Firebase
 * Compatible con la estructura Firebase completa
 * Características:
 * - Control automático y manual de 2 sensores de humedad
 * - Sincronización completa con Firebase (manual_on, manual_off, fecha)
 * - Registro de historial con retraso de 5s
 * - Modo manual con timeout de 20s
 * - Streaming en tiempo real desde Firebase
 * - Carga inicial de configuración mejorada
